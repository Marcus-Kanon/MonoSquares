...
namespace MonoSquaresServer.Physics
{
    class PhysicsEngine
    {
        ...
        public PhysicsEngine BindEntity(IPhysics entity)
        {
        ...
        public IPhysics HasCollidedWith(IPhysics entity, bool lookAhead=false)
        {
            foreach (var collidableEntity in GetCollidableEntities())
            {
                if(lookAhead)
                {
                    ...
                    if (nextPosition.IntersectsWith(collidableEntity.Body) && entity != collidableEntity && entity.IsSolid && !entity.Collided)
                    {
                ...
                {
                    if (entity.Body.IntersectsWith(collidableEntity.Body) && entity != collidableEntity && entity.IsSolid && !entity.Collided)
                    {
